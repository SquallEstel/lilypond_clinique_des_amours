...
"Mimi 4" = \relative c {
  ...
  \bar "||"
  \key d \major
  %{ 20 %} \PM r4 \Annot "H" #'( "!pp" "legg." ) d''8 cis
  ...
  %{ 28 %} d8 r r4
  %{ 29 %} R2*7
  %{ 36 %} \PM r8. a'16\f <fis d'>8 <a e'>
  %{ 37 %} <d fis>8 r r4
  %{ 38 %} R2*2
  %{ 40 %} r8. b16\f <g e'>8 <b fis'>
  %{ 41 %} <e g>8 r r4
  %{ 42 %} R2
  %{ 43 %} R2\fermata
  %{ 44 %} r8. a,16\mf d,8 e
  ...
  %{ 50 %} e8.[( fis16]) g r a8
  %{ 51 %} b16 b b b cis8 b
  %{ 52 %} a8 r16 a\f <fis d'>8 <a e'>
  %{ 53 %} <d fis>8 r r4
  %{ 54 %} R2*2
  %{ 56 %} r8. b16\f <g e'>8 <b fis'>
  %{ 57 %} <e g>8 r r4
  %{ 58 %} R2
  %{ 59 %} << { <g, cis>2\fermata\p } { s8. \Annot "H" #'( "cresc." ) s16 s4 } >>
  %{ 60 %} <fis d'>2~\f
  %{ 61 %} <fis d'>8 r r4
  %{ 62 %} R2*2
  ...
  \bar "||"
  \key d \major
  %{ 80 %} \PM r4 \Annot "H" #'( "!pp" "legg." ) d'8 cis
  ...
  %{ 88 %} d8 r r4
  %{ 89 %} R2*7
  %{ 96 %} \PM r8. a'16\f <fis d'>8 <a e'>
  %{ 97 %} <d fis>8 r r4
  %{ 98 %} R2*2
  %{ 100 %} r8. b16\f <g e'>8 <b fis'>
  %{ 101 %} <e g>8 r r4
  %{ 102 %} R2
  %{ 103 %} R2\fermata
  ...
  %{ 112 %} a8 r16 a\f <fis d'>8 <a e'>
  %{ 113 %} <d fis>8 r r4
  %{ 114 %} R2*2
  %{ 116 %} r8. b16\f <g e'>8 <b fis'>
  %{ 117 %} <e g>8 r r4
  %{ 118 %} R2
  %{ 119 %} << { <g, cis>2\fermata\p } { s8. \Annot "H" #'( "cresc." ) s16 s4 } >>
  %{ 120 %} <fis d'>4\f~ <fis d'>8 r\fermata
  \bar "|."
}

"Paroles Mimi 4" = \lyricmode {
  L'a -- mour est un oi -- seau re -- bel -- le
  Que nul ne peut ap -- pri -- voi -- ser.
  Et c'est bien en vain qu'on l'ap -- pel -- le,
  S'il lui con -- vient de __ re -- fu -- ser!
